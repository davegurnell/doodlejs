...
var Vec = require("./math").Vec;

var _image = require("./image");

var Circle = _image.Circle;
var Rectangle = _image.Rectangle;
var Triangle = _image.Triangle;
var Overlay = _image.Overlay;
var Beside = _image.Beside;
...
var BoundingBox = exports.BoundingBox = (function () {
  function BoundingBox() {
    ...
    var bottom = arguments[2] === undefined ? 0 : arguments[2];
    var left = arguments[3] === undefined ? 0 : arguments[3];
...
},{"./image":7,"./math":8}],6:[function(require,module,exports){
"use strict";
...
function draw(ctx, image) {
  ...
  var center = Vec.xy(ctx.canvas.width / 2, ctx.canvas.height / 2);
...
function drawImage(ctx, bounds, style, image) {
  if (image instanceof Circle) {
    ...
    var bOrigin = origin.add(Vec.xy(0, iBounds.bottom - 0.5 * bBounds.height));
...
},{"./bounds":5,"./image":7,"./math":8,"underscore":4}],7:[function(require,module,exports){
"use strict";
...
var Image = exports.Image = (function () {
  ...
  _createClass(Image, {
    ...
    above: {
      value: function above(that) {
        return new Above(this, that);
      }
    },
    below: {
      value: function below(that) {
        return new Above(that, this);
      }
    },
    on: {
      value: function on(that) {
        return new Overlay(this, that);
      }
    },
    under: {
      value: function under(that) {
...
var StyleTransform = exports.StyleTransform = (function (_Image7) {
  ...
  _inherits(StyleTransform, _Image7);
...
function createExpression(createPair) {
  return function (a) {
    ...
    var ans = _.reduce(b, createPair, a);
    return ans;
  };
}

var beside = createExpression(function (a, b) {
  return new Beside(a, b);
});
exports.beside = beside;
var above = createExpression(function (a, b) {
  return new Above(a, b);
});
exports.above = above;
var below = createExpression(function (a, b) {
  return new Above(b, a);
});
exports.below = below;
var on = createExpression(function (a, b) {
  return new Overlay(a, b);
});
exports.on = on;
var under = createExpression(function (a, b) {
  return new Overlay(b, a);
});
exports.under = under;
...
var Vec = exports.Vec = (function () {
  ...
  _createClass(Vec, {
    ...
    polar: {
      value: function polar(angle, length) {
...
},{"./layout":10,"./sierpinski":11}],10:[function(require,module,exports){
"use strict";

var _coreImage = require("../core/image");

var circle = _coreImage.circle;
var triangle = _coreImage.triangle;
var beside = _coreImage.beside;

var c = circle(10);
var t = triangle(20, 20);

module.exports = beside(c.above(t), c.beside(t), c.below(t), t.beside(c), c.on(t), c.under(t));

},{"../core/image":7}],11:[function(require,module,exports){
"use strict";
...
function sierpinski(n) {
  if (n == 0) {
    ...
    var smaller = sierpinski(n - 1);
    return smaller.above(smaller.beside(smaller));
  }
}

},{"../core/image":7}],"demo":[function(require,module,exports){
"use strict";
...
var CodeMirror = _interopRequire(require("codemirror/lib/codemirror"));

var CodeMirrorJs = _interopRequire(require("codemirror/mode/javascript/javascript"));
...
},{"codemirror/lib/codemirror":1,"codemirror/mode/javascript/javascript":2,"jquery":3}],"doodle":[function(require,module,exports){
"use strict";
...
var math = _interopRequireWildcard(require("./core/math"));

var image = _interopRequireWildcard(require("./core/image"));

var bounds = _interopRequireWildcard(require("./core/bounds"));

var canvas = _interopRequireWildcard(require("./core/canvas"));
...
},{"./core/bounds":5,"./core/canvas":6,"./core/image":7,"./core/math":8,"./examples":9}]},{},[]);
